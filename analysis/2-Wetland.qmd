...
For detailed code on how the raster was processed, please refer to this 
...
::: {.grid}
::: {.g-col-6} 
![Figure 1: Macrophytes (Mortillaro et al., 2016)](/images/macrophyte.jpg){fig-alt="Macrophyte" id="plant1"}
:::

::: {.g-col-6} 
![Figure 2: Flooded forest (Amazon Waters Alliance, 2024)](/images/forest.jpeg){fig-alt="Forest" id="plant2"}
:::
:::